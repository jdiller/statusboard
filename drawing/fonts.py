...
# Font file paths
LIBERATION_SANS_REGULAR = "LiberationSans-Regular"
    ...
    try:
        ...
        if font_name == SYMBOLS:
            if os.path.exists(font_name):
                ...
                font = ImageFont.truetype(LIBERATION_SANS_REGULAR, size)
        else:
